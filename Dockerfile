...
RUN --mount=type=cache,id=s/56a81294-ad94-48f4-b5e0-8ed54fc8b3b6-pnpm-store,target=/root/.local/share/pnpm/store,sharing=locked \
...
RUN --mount=type=cache,id=s/56a81294-ad94-48f4-b5e0-8ed54fc8b3b6-apt-cache,target=/var/cache/apt,sharing=locked \
    --mount=type=cache,id=s/56a81294-ad94-48f4-b5e0-8ed54fc8b3b6-apt-lists,target=/var/lib/apt,sharing=locked \
    apt-get update && \
